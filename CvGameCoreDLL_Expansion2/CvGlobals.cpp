...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(QUEST_DISABLED_GIFT_SPECIFIC_UNIT, 0),
	...
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_MILITARISTIC_GIFT_SPECIFIC_UNIT, 200),
	GD_INT_INIT(MINOR_CIV_QUEST_WEIGHT_MULTIPLIER_OTHER_GIFT_SPECIFIC_UNIT, 75),
	...
	GD_INT_INIT(CLOSE_TO_DIPLOMATIC_VICTORY_THRESHOLD, 75),
	GD_INT_INIT(CLOSE_TO_SCIENCE_VICTORY_THRESHOLD, 80),
	GD_INT_INIT(CLOSE_TO_CULTURE_VICTORY_THRESHOLD, 75),
	...
	GD_INT_INIT(GREAT_MUSICIAN_BLAST_HAPPINESS, 2),
	...
	GD_INT_INIT(EMPIRE_SIZE_NEED_MODIFIER_POP, 25),
	...
	GD_INT_INIT(BARBARIAN_SPAWN_DELAY_FROM_ENCAMPMENT_RAND, 10),
	...
	GD_INT_INIT(BARBARIAN_SPAWN_DELAY_FROM_CITY_RAND, 5),
	...
	GD_INT_INIT(ESPIONAGE_SPY_RESISTANCE_MAXIMUM, 1000),
	...
	GD_INT_INIT(ESPIONAGE_KILL_CHANCE_DECREASE_PER_SPY_LEVEL, 0),
	GD_INT_INIT(ESPIONAGE_MODIFIER_SPY_LEVEL_AGENT, 0),
	GD_INT_INIT(ESPIONAGE_MODIFIER_SPY_LEVEL_SPECIAL_AGENT, 0),
	...
	GD_INT_INIT(ESPIONAGE_DEFENDING_SPY_EXPERIENCE, 50),
	GD_INT_INIT(ESPIONAGE_DIPLOMAT_SPY_EXPERIENCE, 25),
	GD_INT_INIT(ESPIONAGE_OFFENSIVE_SPY_EXPERIENCE, 20),
	...
	GD_FLOAT_INIT(UNHAPPINESS_PER_PILLAGED_TILE, 0.50f),
...
void CvGlobals::cacheGlobals()
{
	...
	GD_INT_CACHE(GREAT_MUSICIAN_BLAST_HAPPINESS);
	...
	GD_INT_CACHE(ESPIONAGE_SPY_RESISTANCE_MAXIMUM);
	...
	GD_INT_CACHE(ESPIONAGE_KILL_CHANCE_DECREASE_PER_SPY_LEVEL);
	GD_INT_CACHE(ESPIONAGE_MODIFIER_SPY_LEVEL_AGENT);
	GD_INT_CACHE(ESPIONAGE_MODIFIER_SPY_LEVEL_SPECIAL_AGENT);
	...
	GD_INT_CACHE(ESPIONAGE_DEFENDING_SPY_EXPERIENCE);
	GD_INT_CACHE(ESPIONAGE_DIPLOMAT_SPY_EXPERIENCE);
	GD_INT_CACHE(ESPIONAGE_OFFENSIVE_SPY_EXPERIENCE);
